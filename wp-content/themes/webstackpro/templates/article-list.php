...
?>
<div class="slice-article mb-4" <?php echo (io_get_option('search_skin') && io_get_option('search_skin')['search_big'] && io_get_option('search_skin')['post_top'] && io_get_option('search_position') && in_array("home",io_get_option('search_position')))?'style="margin-top:-6rem!important"':''?>> 
